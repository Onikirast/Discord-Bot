...
and testing this bot. Kept to make the project easy to pick back up
later, and to have an honest record of what actually went wrong along
the way, not just the finished result.
